...
def parse_opt():
    ...
    parser.add_argument("runs/train/exp50/weights/best.pt", type=str, default="yolov8n.pt", help="initial weights path")
    parser.add_argument("/dataspace/grj/laov8/People.mp4", type=str, default='ultralytics/assets/bus.jpg', help="video file path or Photo")
