...
counting_regions = [
    ...
    # (0, 640)      # 左下角
    {
        ...
        'polygon': Polygon([(0, 0), (640, 0), (640, 640), (0, 0)]),  # Polygon points
        'counts': 0,
        'dragging': False,
        'region_color': (0, 0, 0),  # BGR Value
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='/dataspace/grj/laov8/runs/train/exp258/weights/best.pt', help='initial weights path')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--source', type=str, default='/dataspace/grj/nongyanshipin/output_rgb.mp4', help='video file path')
