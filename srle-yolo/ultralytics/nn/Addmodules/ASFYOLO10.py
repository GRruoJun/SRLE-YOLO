import torch #10,最原版d基础上改成统一到p2尺寸
...
class ScalSeq(nn.Module):
    def __init__(self, inc, channel):
        ...
        self.upsample = nn.Upsample(size=None, scale_factor=(2, 1, 1), mode='nearest')  # 根据需要调整 scale_factor
        self.pool_2d = nn.MaxPool2d(kernel_size=(2, 2))  # 使用2D池化
    def forward(self, x):
        ...
        # 对 p5 进行上采样到 p4 的尺寸
        p5_2 = F.interpolate(p5_2, p4_2.size()[2:], mode='nearest')
