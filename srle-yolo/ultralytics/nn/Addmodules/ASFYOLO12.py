...
class ScalSeq(nn.Module):
    def __init__(self, inc, channel):
        ...
        self.attention_module = AttentionModule(channel)  # 使用 AttentionModule
    ...
    def forward(self, x):
        ...
        p4_2  = self.attention_module(p4_2)
        p5_2 = self.attention_module(p5_2)
